        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/reportnumber/create') }}" class="btn btn-success btn-sm" title="Add New reportnumber">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/admin/reportnumber') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($reportnumber as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/admin/reportnumber' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                            ...
                            <div class="pagination-wrapper"> {!! $reportnumber->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
