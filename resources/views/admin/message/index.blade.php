            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/admin/message') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                            ...
                            <table class="table">
                                ...
                                @foreach($message as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->id }}</td><td>{{ $item->addressmessage }}</td><td>{{ $item->name }}</td>
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/message/' . $item->id . '/edit') }}" title="Edit message"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST" action="{{ url('/admin/message' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
